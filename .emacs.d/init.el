...
;; on a mac these should be set to S-left, S-right, etc.
...
;(add-to-list 'load-path "c:/emacs/emacs-23.2/lisp/")
;(add-to-list 'load-path "c:/emacs/emacs-23.2/lisp/progmodes/python.el")
...
; From http://www.emacswiki.org/emacs/EightyColumnRule
(require 'whitespace)
